...
async function crear(req, res, next) {
    ...
    try {
        ...
        const [results] = await connection.query(query, [idUsuario,nombre,99,fechaInicio,fechaFin,]); 
            ...
            try {
                ...
                for (const herramienta of herramientas) {
                    ...
                    if (herramienta.idHerramienta === 13){
                        ...
                        const [results] = await connection.query(query,[idProyecto,2,0,0]);
                ...
                try {
                    ...
                    for (const participante of participantesSupervisores) {
                        ...
                        console.log(`Se agrego el usuario ${participante.idUsuario} 
