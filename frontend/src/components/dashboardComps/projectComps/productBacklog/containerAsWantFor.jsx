    ...
    return (
        <div className="containerDescription">
            <div className="customInput">
                ...
                <input type="text" id="customPlaceholderInput1" className="customPlaceholderInput" placeholder="Escribe aquí"  maxLength="100"/>
            </div>
            <div className="customInput">
                <label htmlFor="customPlaceholderInput2" className="placeholderLabel">Quiero...</label>
                <input type="text" id="customPlaceholderInput2" className="customPlaceholderInput" placeholder="Escribe aquí"  maxLength="100"/>
            </div>
            <div className="customInput">
