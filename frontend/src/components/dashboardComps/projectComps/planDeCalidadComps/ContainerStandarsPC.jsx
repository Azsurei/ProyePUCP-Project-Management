...
export default function ContainerStandarsPC({
    indice,
    updateStandarsField,
    standars,
    functionRemove,
    ...
    const inputId1 = `customPlaceholderStandarsInput1-${indice}`;

    const [isTextTooLong1, setIsTextTooLong1] = useState(false);

    const handleInputChange = (value) => {
        updateStandarsField(indice, value);
    };
