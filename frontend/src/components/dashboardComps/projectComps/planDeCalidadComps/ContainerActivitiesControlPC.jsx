...
export default function ContainerActivitiesControlPC({
    indice,
    ...
    const inputId1 = `customPlaceholderActivitiesControlInput1-${indice}`;

    const [isTextTooLong1, setIsTextTooLong1] = useState(false);

    const handleInputChange = (value) => {
        updateActivitiesControlField(indice, value);
    };
    ...
    return (
        <div className="containerBack">
            <Textarea
                ...
                value={activitiesControl.activitiesControl}
