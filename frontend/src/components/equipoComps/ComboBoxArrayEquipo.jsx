...
export default function ComboBoxArrayEquipo({ people, onSelect, autoSelectedValue }) {
            ...
            >
                <div className="relative mt-1">
                    <div className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left  focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
                        <Combobox.Input
                            className={`w-full border-2 py-2 pl-3 pr-10 text-sm leading-5 text-gray-900 focus:ring-0 relative`}
                            onChange={(event) => setQuery(event.target.value)}
                            displayValue={(person) => person.nombreRol} //lo que se muestra en el input
                        />
