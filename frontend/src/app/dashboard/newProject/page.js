  ...
  return (
    <div className="mainDivNewProject">
      ...
      <div className="containerInfoBox">
        <div className="buttonContainerPrev" onClick={handlePrevLevel}>
        ...
        <div className="infoBox">
          {estadoProgress === 1 && <CardCreateProject></CardCreateProject>}
        ...
        <div className="buttonContainer" onClick={handleNextLevel}>
          <button className="myButton" onClick={cambiarEstadoAdelante}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="79"
              height="79"
      ...
      <div className="buttonContainerCreate">
        <button className="createProjectButtonEnd">Crear Proyecto</button>
      </div>
    </div>
  );
}
