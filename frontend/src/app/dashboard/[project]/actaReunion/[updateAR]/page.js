...
// *********************************************************************************************
    ...
    const handleAddTema = ()=>{
        ...
        setNumeroTemas(prevTemas => [
            ...prevTemas, 
            {
              value: `tema${prevTemas.length + 1}`,
              label: `Tema ${prevTemas.length + 1}`
            }
          ]);
    }
    ...
    const handleRemoveTema = (index) => {
        ...
        setNumeroTemas(updatedNumTemas);
    }
    ...
    useEffect(() => {
        console.log("Nombres de Temas:", numeroTemas);
    }, [numeroTemas]);
