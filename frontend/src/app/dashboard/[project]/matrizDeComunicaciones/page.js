...
export default function MatrizDeComunicaciones(props){
    ...
    const stringURL = process.env.NEXT_PUBLIC_BACKEND_URL+`/api/proyecto/matrizDeComunicaciones/listarMatrizComunicacion/59`
    ...
    function DataTable(){
        const fetchData = async () => {
          try {
            ...
            const stringURL =
            process.env.NEXT_PUBLIC_BACKEND_URL+"/api/proyecto/matrizDeComunicaciones/listarMatrizComunicacion/" +
            projectId;
    ...
    return(
        ...
        <div className="container">
            ...
            <div className="matrizComunicaciones">
                <div className="titleComunicaciones h-auto my-4 text-center dark:text-white">Matriz de Comunicaciones</div>
