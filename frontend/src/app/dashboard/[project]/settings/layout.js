...
export default function RootLayout({ children, params }) {
    ...
    const baseUrlString = "/dashboard/" + encodeURIComponent(projectName) + "=" + encodeURIComponent(projectId)  + "/settings";
                ...
                <div className="flex flex-row w-[100%] h-[100%] space-x-8 overflow-hidden">
                    <div className="flex flex-col h-[100%] w-[20%] space-y-1">
                        ...
                        <Link
                            ...
                            onClick={()=>{console.log(pathname); console.log(baseUrlString + "/general")}}
                        >
                            General
                        </Link>
                        <Link
